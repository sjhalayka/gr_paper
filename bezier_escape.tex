...
Note that the round-trip time in the absence of the Sun is $\epsilon = 4 R_y / c$, and that the time in the presence of the Sun is $\epsilon + \delta_{s}$, which is just a little bit longer.
}
\end{figure}
