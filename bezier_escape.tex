...
\end{equation}
For instance, in the case of the Earth, where $\lambda{e} = 1$, $M = 5.9722 \times 10^{24}$, and $r_e = 6.371 \times 10^6$, it is found that $\lambda_{\infty} = 1.0000000006960998444$.
