...
\end{equation}
metres.
For instance, in the case of the Earth, where $\lambda_{e} = 1$, $M = 5.9722 \times 10^{24}$, $r_e = 6.371 \times 10^6$, and $r_i$ is practically infinite, it is found that $\lambda_{i} = 1.0000000006961$.
The numerically predicted amount is like $1.0000000006961$ metres, which is practically identical to the amount given by the analytical solution.
