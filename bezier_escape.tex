...
For instance, Einstein's light clock thought experiment is helpful for understanding kinematic time dilation, where $\vec{v}$ is the 3-dimensional velocity vector, the speed of light in vacuum is precisely $c = 299792458$, and $d\tau/dt$ is the rate of time (e.g. clock tick rate):
\begin{equation}
