...
\delta_{t} = \frac{1}{c}.
\end{equation}
The analytical solution for the Shapiro time delay is:
\begin{equation}
\label{delta_s}
...
Note that the analytical solution is only an approximation, and that the numerical solution is the correct one by default.
