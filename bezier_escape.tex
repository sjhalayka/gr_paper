...
\item
We found that Eq. \ref{wl_inf} and the numerical solution both predict the same amount of redshift of the photons that escape the gravitational field (e.g. an increase in wavelength to $1.00000212$ metres).
...
Finally, the solution calculated an increase in wavelength to $1.00000212$ metres because of gravitational redshift.
