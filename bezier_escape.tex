...
See Fig. 1 for a diagram of the symmetric communication system.
...
\item
In the end, we have simulated the deflection of photons and neutrinos by the Sun, the relativistic rotation of Mercury's orbit plane, the Shapiro time delay.
...
\centering
  ...
  \caption{ Communication system for predicting the Shapiro time delay.
The Sun is shown in the centre, not to scale.
}
