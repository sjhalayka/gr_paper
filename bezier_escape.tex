...
No tensor calculus is involved -- only high school Physics is required (e.g. basic linear algebra, such as 3-dimensional vectors).

The light clock thought experiment is helpful for understanding kinematic time dilation.
After one understands the kinematic time dilation, it is not too far a stretch for them to understand gravitational time dilation -- gravitation is the interruption of internal process by some other process at some distance away.
