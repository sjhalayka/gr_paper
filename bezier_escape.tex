...
\item
We found that Eq. \ref{wl_inf} and the numerical solution both predict the same amount of redshift of the photons that escape the gravitational field (e.g. an increase in wavelength of $2.12 \times 10^{-6}$ metres).
...
Finally, the solution calculated an increase in the wavelength of $2.12 \times 10^{-6}$ metres because of gravitational redshift.
